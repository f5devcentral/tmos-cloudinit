...
def do_declaration_dir_exists():
    ...
    os.makedirs(DO_DECLARATION_DIR, exist_ok=True)
...
def as3_declaration_dir_exists():
    ...
    os.makedirs(AS3_DECLARATION_DIR, exist_ok=True)
...
def download_as3_declaration(declaration_url=None):
    ...
    if declaration_url:
        ...
        while (not os.path.exists(AS3_DECLARATION_FILE)) and (
                download_tries < DECLARATION_DOWNLOAD_RETRIES):
            if download_file(declaration_url,
...
def ts_declaration_dir_exists():
    ...
    os.makedirs(TS_DECLARATION_DIR, exist_ok=True)
...
def download_file(source_url=None,
    ...
    if source_url and destination_file:
        try:
            ...
            LOG.error('could not download %s to %s', source_url, destination_file)
            return False
        except Exception as err:
