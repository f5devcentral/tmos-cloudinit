...
def persist_do_declaration(declaration=None, additional_declarations=None):
    ...
    if declaration and additional_declarations:
        ...
        util.write_file(DO_DECLARATION_FILE, json.dumps(additional_declarations))
        


def persist_do_declaration_from_url(declaration=None, additional_declaration_url=None):
    ...
    if additional_declaration_url:
        if download_file(additional_declaration_url, DO_DECLARATION_DIR,
            ...
            try:
                with open("%s/additional_declarations" % DO_DECLARATION_DIR,
                          'r') as ad:
                    if declaration:
                        ...
                        declaration = yaml.safe_load(ad.read())
            except Exception as ex:
                LOG.error(
