...
def initialize_do_declaration(do_schema_version="1.0.0"):
...
def resolve_resources(rd_enabled=True,
                      ...
                      inject_routes=True,
                      do_enabled=False, do_schema_version="1.0.0",
                      dhcp_timeout=120,
                      dhcpv4_options=None):
    """Resolve the resource provisioning dataset from metadata"""
    do_declaration = None
    if do_enabled:
        do_declaration = initialize_do_declaration(do_schema_version)
...
def create_onboard_artifacts(resources,
                             ...
                             do_additional_declarations_url_headers=None,
    ...
    if do_enabled:
        tmos_onboard_utils.persist_do_declaration(
            ...
            do_additional_declarations_url_headers,
...
def onboard(trusted_sources, icontrollx_package_urls, do_enabled, ts_enabled,
            as3_enabled, post_onboard_enabled, phone_home_url, phone_home_url_headers,
...
def handle(name, cloud_config, cloud, log, args):
    ...
    if enabled:
        ...
        do_schema_version = "1.0.0"
        if 'do_schema_version' in cloud_config[tag]:
            do_schema_version = cloud_config[tag]['do_schema_version']
        do_additional_declarations = None
        do_additional_declarations_url = None
        do_additional_declarations_headers = None
        do_template_variables = None
        ...
        if 'do_declaration_url_headers' in cloud_config[tag]:
            do_additional_declarations_headers = cloud_config[tag]['do_declaration_url_headers']
        ...
        resources = resolve_resources(rd_enabled, default_route_interface,
                                      ...
                                      do_enabled, do_schema_version,
                                      dhcp_timeout, dhcpv4_options)
        ...
        create_onboard_artifacts(resources, do_enabled,
                                 do_additional_declarations,
                                 do_additional_declarations_url,
                                 do_additional_declarations_headers,
                                 do_template_variables, ts_declaration,
                                 ts_declaration_url,
                                 ts_declaration_url_headers,
                                 ts_template_variables,
                                 as3_declaration,
        ...
        try:
            onboard(icontrollx_trusted_sources, icontrollx_package_urls,
                    ...
                    phone_home_url, phone_home_url_headers, phone_home_url_verify_tls,
