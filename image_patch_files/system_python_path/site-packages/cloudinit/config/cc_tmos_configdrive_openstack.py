...
def create_onboard_artifacts(resources,
    ...
    if do_enabled:
        tmos_onboard_utils.persist_do_declaration(
            ...
            do_additional_declarations_url, do_template_variables)
    if ts_declaration:
        try:
    ...
    if as3_declaration_url:
        try:
            tmos_onboard_utils.download_as3_declaration(
                as3_declaration_url, as3_template_variables)
        except Exception as err:
...
def handle(name, cloud_config, cloud, log, args):
    ...
    if enabled:
        ...
        create_onboard_artifacts(resources, do_enabled,
                                 ...
                                 ts_declaration_url, ts_template_variables,
                                 as3_declaration, as3_declaration_url,
                                 as3_template_variables, post_onboard_commands)
