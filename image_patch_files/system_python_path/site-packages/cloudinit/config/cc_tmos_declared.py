...
def onboard(do_declaration, do_declaration_url, do_template_variables,
            as3_declaration, as3_declaration_url, as3_template_variables,
            ts_declaration, ts_declaration_url, ts_template_variables,
            trusted_sources, post_onboard_enabled, post_onboard_commands,
            phone_home_url, phone_home_url_verify_tls, phone_home_url_metadata,
            phone_home_cli):
    """Implements the onboarding business logic"""

    do_enabled = True
    try:
        tmos_onboard_utils.persist_do_declaration(None, do_declaration,
                                                  do_declaration_url,
    ...
    if as3_declaration:
        ...
        try:
            tmos_onboard_utils.download_as3_declaration(
                as3_declaration_url, ts_template_variables)
        except Exception as err:
...
def handle(name, cloud_config, cloud, log, args):
    ...
    if enabled:
        ...
        try:
            onboard(do_declaration, do_declaration_url, do_template_variables,
                    as3_declaration, as3_declaration_url,
                    as3_template_variables, ts_declaration, ts_declaration_url,
                    ts_template_variables, icontrollx_trusted_sources,
