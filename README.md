...
| phone_home_url_headers | none | A dictionary of HTTP headers to include in the phone_home POST request |
...
| as3_declaration_url_headers | none | A dictionary of HTTP headers to include in the GET request for the declaration |
...
| ts_declaration_url_headers | none | A dictionary of HTTP headers to include in the GET request for the declaration |
...
If f5-declarative-onboarding is disabled by setting `do_enabled` to false, the device onboarding configuration will continue as described in the DHCPv4 lease offers or `dhcpv4_options` declarations. f5-appsvcs-extension declarations can be applied with or without f5-declarative-onboarding being enabled.
